...
import logo from "./images/CFLogoFoot.svg";
	...
	return (
		<Container fluid className={styles.foot}>
			<Row className={styles.footerRow}>
				<Col className={styles.footerA}>
					<p className={styles.footerp}> © Cara Fuentes | 2024 </p>
				</Col>
				<Col className={styles.footerLogo}>
					<Image src={logo} alt="logo" />
				</Col>
				<Col className={styles.footerB}>
					<Col className={styles.contact}>
						<p>Contact</p>
					</Col>
					<Col>
						<p>Cara Fuentes, LMHC - Supervisor</p>
						<p className={styles.address}>Port St. Lucie, FL</p>
					</Col>
